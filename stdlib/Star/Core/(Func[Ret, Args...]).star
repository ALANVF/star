...
protocol Func[Ret] of Func[Ret, _], Func[Ret, _, _], Func[Ret, _, _, _] {
	...
	on [call: (_)] (Ret) is inline => return this[call]
	
	on [call: (_), (_)] (Ret) is inline => return this[call]
	
	on [call: (_), (_), (_)] (Ret) is inline => return this[call]
}
...
protocol Func[Ret, Arg1] of Func[Ret, Arg1, _], Func[Ret, Arg1, _, _] {
	...
	on [call: arg1 (Arg1), (_)] (Ret) is inline => return this[call: arg1]
	
	on [call: arg1 (Arg1), (_), (_)] (Ret) is inline => return this[call: arg1]
}
...
protocol Func[Ret, Arg1, Arg2] of Func[Ret, Arg1, Arg2, _] {
	...
	on [call: arg1 (Arg1), arg2 (Arg2), (_)] (Ret) is inline => return this[call: arg1, arg2]
}
